...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("listar").setDescription("Lista todos os seus personagens criados.")
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName("trocar")
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option =>
                    option.setName("nome").setDescription("Nome exato do personagem a ser apagado").setRequired(true)
                )
        ),
