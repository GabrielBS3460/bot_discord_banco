    ...
    try {
        ...
        if (command === 'cadastrar') {
            ...
            try {
                ...
                if (contagem >= 3) {
                    return message.reply("🚫 Você já atingiu o limite de 3 personagens!");
                }
            ...
            try {
                ...
                if (subcomando === 'listar') {
                    ...
                    if (personagens.length === 0)
                        return message.reply("Você não tem personagens. Use `!cadastrar`.");
                    ...
                    if (!nomeAlvo)
                        return message.reply("Use: `!personagem trocar <nome do personagem>`");
                    ...
                    if (!personagemAlvo)
                        return message.reply("Você não possui um personagem com esse nome.");
                    ...
                    if (!nomeAlvo)
                        return message.reply("Use: `!personagem apagar <nome do personagem>`");
            ...
            const CATEGORIAS = {
                ...
                'mestre': {
                    ...
                    comandos: [
                        ...
                        {
                            cmd: '!loot',
                            desc: 'O mestre concede loot aos players ao final do contrato',
                            syntax: '!loot @Player 500'
                        }
                    ]
                }
            };
        ...
        try {
            ...
            if (!destinatarioUser || destinatarioUser.bot) {
                return message.reply("Você precisa mencionar um jogador válido. Ex: `!loot @Player 500`");
            }
            ...
            try {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields(
                        { name: 'Jogador', value: charDestinatario.nome, inline: true },
                        { name: 'Valor Recebido', value: `**${formatarMoeda(valor)}**`, inline: true }
                    )
                    .setFooter({ text: `Concedido por ${message.author.username}` })
                    .setTimestamp();
                ...
                await message.reply("Ocorreu um erro ao conceder o loot.");
            }
        }//Feito
    } catch (err) {
